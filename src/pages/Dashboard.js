  ...
  return (
    ...
    <Container fluid={true} style={{padding:0}}>
      ...
      <Row style={{color:"black"}}>
        <Col xs={12} sm={6} md={3} style={{backgroundColor:"white",paddingTop:2+"rem",fontSize:24}}>   <img height="180" width="220" src={AllLevelLogo1} alt="Logo" />
        <p className="pt-3">HUMAN RESOURCES</p>
        </Col>
        <Col xs={12} sm={6} md={3} style={{backgroundColor:"white",paddingTop:2+"rem",fontSize:24}}>   <img height="180" width="220" src={AllLevelLogo2} />
        <p className="pt-3"> PROJECT MANAGEMENT</p>
        </Col>
        <Col xs={12} sm={6} md={3} style={{backgroundColor:"white",paddingTop:2+"rem",fontSize:24}}>   <img height="180" width="220" src={AllLevelLogo3} />
        <p className="pt-3">UPPER MANAGEMENT</p>
        </Col>
        <Col xs={12} sm={6} md={3} style={{backgroundColor:"white",paddingTop:2+"rem",fontSize:24}}>   <img height="180" width="220" src={AllLevelLogo4} />
